...
def main():
    ...
    val_dataset = AudioDataset('val', INSTRUMENTS, args.sr, args.channels, 1, False, args.h5_dir, shapes, crop_func)
    ...
    while state["worse_epochs"] < args.hold_step:
        ...
        for i, (x, targets) in enumerate(train_loader):
            ...
            if i % args.example_freq == 0:
                input_centre = x[0, :, shapes["start_frame"]:shapes["end_frame"]]
